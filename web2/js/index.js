  ...
  $("#nderive").on("click", function () {
    ...
    $("#wrapper").after(function () {
      return `<div id='backgW'>
                    ...
                    <div id="der">THEORY OF THE DERIVE <i>(GUY DEBORD, 1958)</i></div>
                    <div id="dunderl"></div>
              </div>`;
    });
    $("#backgW").css("height", "620vh");
  ...
  $("#ndeto").on("click", function () {
    ...
    $("#wrapper").after(function () {
      return `<div id='backgW'>
                    ...
                    <div id="det">DETOURNEMENT AS NEGATION AND PRELUDE <i>(1959)</i></div>
                    <div id="dtunderl"></div>
              </div>`;
    });
    $("#backgW").css("height", "237vh");
    if ($("#idd a").css("visibility") === "visible") {
      $("#back").on("click", function () {});
    } else {
      $("#back").on("click", function (e) {
      ...
      return `<div id='backgW'>
                    <div id='urban'>
                        ...
                        <div class='para' id='p2'>
                            ...
                            City planning must be understood as a society’s field of publicity-propaganda, i.e. as the organization of participation in something in which it is impossible to participate.
                        </p>
                        </div>
                        <div class='para' id='p3'>
                            <b>3</br>TRAFFIC CIRCULATION, SUPREME STAGE OF CITY PLANNING</b></br></br>
                            <p>
                        ...
                        <div class='para' id='p4'>
                            <b>4</br>DISTANCIATION FROM THE URBAN SPECTACLE</b></br></br>
                            <p>
                        ...
                        <div class='para' id='p5'>
                            <b>5</br>AN INDIVISIBLE FREEDOM</b>
                            <p>
                        ...
                        <div class='para' id='p7'>
                            <b>7</br>THE ILLUMINATION OF DÉTOURNEMENT</b>
                            <p>
                        ...
                        <div class='para' id='p8'>
                            <b>8</br>CONDITIONS OF DIALOGUE</b>
                            <p>
                        ...
                        <div class='para' id='p9'>
                            <b>9</br>RAW MATERIAL AND TRANSFORMATION</b>
                            <p>
                        ...
                        <div class='para' id='p10'>
                            <b>10</br>END OF THE PREHISTORY OF CONDITIONING</b>
                            <p>
                    ...
                    <div id="urb">BASIC PROGRAM OF THE BUREAU OF UNITARY URBANISM</br><i>(ATTILA KOTÁNYI, RAOUL VANEIGEM, 1961)</i></div>
                    <div id="uunderl"></div>
                    <div id="urunderl"></div>
                </div>`;
    });
    $("#backgW").css("width", "325%");
    $("body").css("overflowY", "hidden");
    if ($("#idd a").css("visibility") === "visible") {
      $("#back").on("click", function () {});
    } else {
    ...
    $("#wrapper").after(function () {
      return `<div id='backgW'>
                    <div id='banas'>
                        ...
                        <div class='para' id='p14'>
                            <h2>14</h2>
                            <p>By directly attacking the mythical organization of appearances, the bourgeois revolutions unintentionally attacked the weak point not only of unitary power but of any hierarchical power whatsoever. Does this unavoidable mistake explain the guilt complex that is one of the dominant traits of bourgeois mentality? In any case, the mistake was undoubtedly inevitable.</br></br>
                            ...
                            Thus, under the pressure of exchange-value and technology (what we might call “mediation at your fingertips”), myth was gradually secularized. Two facts should be noted, however:</br></br>
                        ...
                        <div class='para' id='p15'>
                            <h2>15</h2>
                            <p>We know the battlefield. The problem now is to prepare for battle before the pataphysician, armed with his totality without technique, and the cybernetician, armed with his technique without totality, consummate their political coitus.</br></br>
                        ...
                        <div class='para' id='p18'>
                            <h2>18</h2>
                            <p>All unresolved, unsuperseded antagonisms weaken. Such antagonisms can evolve only by remaining imprisoned in previous, unsuperseded forms (anticultural art within the cultural spectacle, for example). Any radical opposition that fails or that is partially successful (which amounts to the same thing) gradually degenerates into reformist opposition. Fragmentary oppositions are like the teeth on cogwheels, they mesh with each other and make the machine go round — the machine of the spectacle, the machine of power.</br></br>
                        ...
                        <div class='para' id='p30'>
                            <h2>30</h2>
                            <p>So many other banalities could be examined and reversed. The best things never come to an end. Before rereading this text (which even the most mediocre intelligence will be able to understand by the third attempt) the reader would be well advised to pay particular attention to the following points — points as fragmentary as the preceding ones, but which must be discussed in detail and implemented. They concern a central question: the SI and revolutionary power.</br></br>
                    ...
                    <div id="banal">BASIC BANALITIES <i>(RAOUL VANEIGEM, 1963)</i></div>
                    <div id="underl"></div>
                </div>`;
    });
    $("#backgW").css("width", "985%");
    $("body").css("overflowX", "scroll");
    $("body").css("overflowY", "hidden");
    if ($("#idd a").css("visibility") === "visible") {
      $("#back").on("click", function () {});
  ...
  $("#nques").on("click", function () {
    ...
    $("#wrapper").after(function () {
      return `<div id='backgW'>
                    <div id='question'>
                        <div class='para' id='p1'>
                        <b>1</br>What does the word “situationist” mean?</b></br></br>
                            <p>
                        ...
                        <div class='para' id='p2'>
                            <b>2</br>
                            Is the SI a political movement?</b></br></br>
                            <p>
                        ...
                        <div class='para' id='p3'>
                            <b>3</br>
                            Is the SI an artistic movement?</b></br></br>
                            <p>
                        ...
                        <div class='para' id='p4'>
                            <b>4</br>
                            Is the SI an expression of nihilism?</b></br></br>
                            <p>
                        ...
                        <div class='para' id='p5'>
                            <b>5</br>
                            Are the situationist positions utopian?</b>
                            <p>
                        ...
                        <div class='para' id='p6'>
                            <b>6</br>
                            Do you consider it necessary to call yourselves “situationists”?</b>
                            <p>
                        ...
                        <div class='para' id='p7'>
                            <b>7</br>
                            What is original about the situationists, considered as a distinct group?</b>
                            <p>
                        ...
                        <div class='para' id='p8'>
                            <b>8</br>
                            Why don’t people talk about the SI?</b>
                            <p>
                        ...
                        <div class='para' id='p9'>
                            <b>9</br>
                            What support do you give to the revolutionary movement?</b>
                            <p>
                        ...
                        <div class='para' id='p11'>
                            <b>11</br>
                            Is there a relation between your theories and your actual way of life?</b>
                            <p>
                        ...
                        <div class='para' id='p12'>
                            <b>12</br>
                            Are the situationists in the vanguard of leisure society?</b>
                            <p>
                        ...
                        <div class='para' id='p15'>
                            <b>15</br>
                            What value can you attribute to a questionnaire? To this one?</b>
                            <p>
                    ...
                    <div id="que">QUESTIONNAIRE <i>(1964)</i></div>
                    <div id="qunderl"></div>
                </div>`;
    });
    $("#backgW").css("width", "487.5%");
    $("body").css("overflowY", "hidden");
    if ($("#idd a").css("visibility") === "visible") {
      $("#back").on("click", function () {});
    } else {
  ...
  $("#nword").on("click", function () {
    ...
    $("#wrapper").after(function () {
      return `<div id='backgW'>
                    ...
                    <div id="cap">CAPTIVE WORDS <i>(MUSTAPHA KHAYATI, 1966)</i></div>
                    <div id="cunderl"></div>
              </div>`;
    });
  ...
  $("#idd a").on("click", function () {
    ...
    $(".indimg").click(function () {
      ...
      if (filepath == "img/memo/") {
        ...
        txt =
          "Rapport sur la Construction des Situations et sur les Conditions de l'Organisation et de l'Action de la Tendance Situationniste Internationale (cover), 1957";
